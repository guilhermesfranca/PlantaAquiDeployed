      ...
      <div className="bg-[#f0f0f0] rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col gap-6 max-w-2xl mx-auto">
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#96a78d]">Welcome back! Ready to grow new victories today?</p>
          </div>
          {levelLabel && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-2xl bg-white px-5 py-4 shadow-sm">
            <p className="text-xs uppercase tracking-wide text-[#96a78d]">Points</p>
            <p className="text-2xl font-semibold">{points}</p>
          </div>
          <div className="rounded-2xl bg-white px-5 py-4 shadow-sm">
            <p className="text-xs uppercase tracking-wide text-[#96a78d]">Trees Planted</p>
          ...
          <div className="rounded-2xl bg-white px-5 py-4 shadow-sm flex flex-col gap-3">
            <p className="text-xs uppercase tracking-wide text-[#96a78d]">Progress</p>
            ...
            <span className="text-sm font-medium">{safeCompletion}% complete</span>
          </div>
        </div>
      </div>
    </section>
